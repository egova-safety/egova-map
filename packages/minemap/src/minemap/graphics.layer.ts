...
import { IGraphic } from "./map.model";

export interface IGraphicsLayer {
    map: any;
...
export class GraphicsLayer extends base.EventProvider
    implements IGraphicsLayer {
    private GRAPHICS_MAP: base.Map<string, IGraphic> = new base.Map<
        string,
        IGraphic
    >();
    ...
    public remove(graphic: IGraphic) {
