...
export class SelectBox extends base.EventProvider implements base.ISelectBox {
    ...
    public constructor(public mapView: base.MapView, options: any) {
        ...
        this.id = options.id;
        this.edit = new minemap.edit.init(mapView.map, {
            boxSelect: true,
            touchEnabled: false,
        ...
        this.mapView.map.on("edit.record.create", (evt: any) => {
    ...
    public showSelectBar(): void {
        ...
        let mapEle = this.mapView.map._container;
