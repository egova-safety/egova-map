...
export class TrackSegment {
    ...
    public constructor(
        public flagwindRouteLayer: RouteLayer,
        public index: number, // 线路对应路段索引
        public name: string, // 线路名
        public startGraphic: Graphic, // 起点要素
        public endGraphic: Graphic, // 终点要素
        public options: any
    ) {
    ...
    public setMultPoints(points: Array<any>) {
        this.flagwindRouteLayer.onSetSegmentByPoint(
            {
                points: points,
                spatial: this.flagwindRouteLayer.mapView.spatial
            },
            this
        );
        if (!this.speed) this.changeSpeed();
    ...
    public move() {
        ...
        if (this.position === 0) {
            ...
            this.options.onMoveEvent(
                this,
                [this.startGraphic.geometry.x, this.startGraphic.geometry.y],
                angle
            );
            return;
        }
