import { IEnumerable, IEnumerator } from ".";
...
export interface ISet<T> extends IEnumerable<T> {
     ...
     */
    forEach(
        callback: (item: T, source: IEnumerable<T>) => void,
        scope?: any
    ): void;
     ...
     */
    forEach(
        callback: (value: T, index: number, set: ISet<T>) => void,
        scope?: any
    ): void;
     ...
     */
    find(
        callback: (value: T, index: number, set: ISet<T>) => boolean,
        scope?: any
    ): T;
