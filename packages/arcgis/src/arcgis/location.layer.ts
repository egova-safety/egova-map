...
export class LocationLayer extends base.FeatureLayer
    implements base.ILocationLayer {
    public point: any;

    public constructor(public mapView: base.MapView, public options: any) {
