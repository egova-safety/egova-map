 ...
 * 线图层
 */
export class PolylineLayer extends base.BusinessLayer {
    public constructor(mapView: base.MapView, id: string, options: any) {
        super(mapView, id, { ...POLYLINE_LAYER_OPTIONS, ...options });
        this.onInit();
    }
